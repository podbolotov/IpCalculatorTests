...
class TestCalcScreenInitialState:
    ...
    @allure.description(
        "Данный тест проверяет изначальное состояние экрана «Калькулятор» и изначальное состояние нижней "
        "навигационной панели.\n"
        "Относительно экрана «Калькулятор» производятся следующие проверки:\n"
        "- На экране отображается изображение-плейсхолдер для состояния \"до вычисления\"\n"
        "- На экране отображается текст-плейсхолдер для состояния \"до вычисления\"\n"
        "- На экране отображается контейнер с полями ввода IP-адреса\n"
        "   - Предзаполненное значение IP-адреса соответствует значению 192.168.1.1\n"
        "- На экране отображается кнопка выбора маски подсети\n"
        "   - Предзаполненное значение маски подсети соответствует значению 24\n"
        "- На экране отображается кнопка «Вычислить»\n"
        "   - Кнопка «Вычислить» активна\n"
        "- На экране отображается кнопка «Поделиться»\n"
        "   - Кнопка «Поделиться» не активна\n\n"
        "Относительно же нижней навигационной панели - следующие:\n"
        "- На навигационной панели отображается кнопка «Калькулятор»\n"
        "   - Кнопка «Калькулятор» активна\n"
        "   - Кнопка «Калькулятор» выбрана\n"
        "- На навигационной панели отображается кнопка «Инфо»\n"
        "   - Кнопка «Инфо» активна\n"
        "   - Кнопка «Инфо» не выбрана\n"
        "- На навигационной панели отображается кнопка «Настройки»\n"
        "   - Кнопка «Настройки» активна\n"
        "   - Кнопка «Настройки» не выбрана\n\n"
